...
amm_arb_config_map = {
    ...
    "connector_1": ConfigVar(
        key="connector_1",
        prompt=_("Enter your first connector (Exchange/AMM/CLOB) >>> "),
        prompt_on_new=True,
    ...
    "connector_2": ConfigVar(
        key="connector_2",
        prompt=_("Enter your second connector (Exchange/AMM/CLOB) >>> "),
        prompt_on_new=True,
        validator=validate_connector,
        on_validated=exchange_on_validated),
    "market_2": ConfigVar(
    ...
    "pool_id": ConfigVar(
        key="pool_id",
        prompt=_("Specify poolId to interract with on the DEX connector >>> "),
        prompt_on_new=False,
        type_str="str",
        default=""),
    ...
    "min_profitability": ConfigVar(
        ...
        prompt=_("What is the minimum profitability for you to make a trade? (Enter 1 to indicate 1%) >>> "),
        prompt_on_new=True,
        default=Decimal("1"),
    ...
    "market_2_slippage_buffer": ConfigVar(
        ...
        prompt=_(
            "How much buffer do you want to add to the price to account for slippage for orders on the second market"
            " (Enter 1 for 1%)? >>> "),
        prompt_on_new=True,
    ...
    "concurrent_orders_submission": ConfigVar(
        ...
        prompt=_("Do you want to submit both arb orders concurrently (Yes/No) ? If No, the bot will wait for first "
    ...
    "debug_price_shim": ConfigVar(
        ...
        prompt=_("Do you want to enable the debug price shim for integration tests? If you don't know what this does "
    ...
    "gateway_transaction_cancel_interval": ConfigVar(
        ...
        prompt=_("After what time should blockchain transactions be cancelled if they are not included in a block? "
    ...
    "rate_oracle_enabled": ConfigVar(
        ...
        prompt=_("Do you want to use the rate oracle? (Yes/No) >>> "),
        default=True,
        validator=validate_bool,
        type_str="bool"),
    "quote_conversion_rate": ConfigVar(
        key="quote_conversion_rate",
        prompt=_("What is the fixed_rate used to convert quote assets? >>> "),
        default=Decimal("1"),
        validator=lambda v: validate_decimal(v),
        type_str="decimal"),
}
